...
output_json=/opt/ProvisioningAPI_2022/Disable_UIUX_Runtime_API/output.json
destn_invent=/opt/ProvisioningAPI_2022/Disable_UIUX_Runtime_API/inventory.txt
...
ansible-playbook /opt/ProvisioningAPI_2022/Disable_UIUX_Runtime_API/Disable_main.yml -i $destn_invent --extra-vars="customer_env=$ecosys_name"
